...
from sol.config import SolConfig, load_config
...
from sol.learning.hints import HintStore
from sol.jobs.storage import JobStore
from sol.plugins.manager import PluginManager
from sol.runtime.paths import RuntimePaths, build_runtime_paths, ensure_runtime_dirs
...
def build_runtime_services(*, cfg: SolConfig, confirm: Callable[[str], bool]) -> RuntimeServices:
