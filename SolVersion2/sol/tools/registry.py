...
from sol.tools.base import Tool, ToolValidationError
...
def build_default_registry() -> ToolRegistry:
    ...
    from sol.tools.exec import ExecRunTool
    from sol.tools.monster import MonsterGenerateTool
    from sol.tools.rag import RagIngestPathTool, RagQueryTool, RagUpsertTextTool
    from sol.tools.repo import RepoFetchFileTool, RepoIngestTool, RepoTreeTool
    from sol.tools.selfcheck import SelfCheckRunTool
    from sol.tools.tibia import TibiaIngestThreadTool, TibiaLearnTool, TibiaSearchSourcesTool
    from sol.tools.web import WebCrawlTool, WebFetchTool, WebSearchTool
    from sol.tools.web_ingest import WebIngestCrawlTool
    from sol.tools.web_ingest_url import WebIngestUrlTool
    from sol.tools.voice import VoiceStubTool
    from sol.tools.vision import VisionStubTool
    from sol.tools.hermesbk_tools import register_hermesbk_tools
