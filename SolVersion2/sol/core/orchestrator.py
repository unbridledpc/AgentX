...
class RuntimeOrchestrator:
    ...
    def run_chat(
        ...
        *,
        ...
        from sol.core.runtime_models import AgentResult, Plan
        ...
        if decision.action == "web_verify" and not plan.steps:
            from sol.core.runtime_models import Plan as RuntimePlan
    ...
    def run_tool(self, *, tool_name: str, tool_args: dict[str, Any], reason: str):
        from sol.core.runtime_models import AgentResult, Plan, PlanStep
    ...
    def execute_plan(self, plan) -> list[Any]:
        ...
        for idx, step in enumerate(plan.steps):
            ...
            if not retry.allowed:
                from sol.core.runtime_models import ToolResult
